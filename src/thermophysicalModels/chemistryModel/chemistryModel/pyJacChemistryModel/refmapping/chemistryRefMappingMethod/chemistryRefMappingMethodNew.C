...
Foam::autoPtr<Foam::chemistryRefMappingMethod<CompType, ThermoType>>
Foam::chemistryRefMappingMethod<CompType, ThermoType>::New
(
...
)
{
    ...
    return autoPtr<chemistryRefMappingMethod<CompType, ThermoType>>
    (
